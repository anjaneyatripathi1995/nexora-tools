...
<div class="auth-form">
    ...
    <p class="auth-subtitle">Sign in to your Nexora Tools account</p>
    ...
    <div class="auth-links">
        ...
        @endif
        <p class="auth-links-row"><span class="auth-links-muted">No account? </span><a href="{{ route('register') }}">Create one</a></p>
    </div>
