...
<div class="pdf-convert-hero mb-4">
    ...
    <div id="pdf2x_status" class="alert alert-info d-none" role="alert" style="max-width:600px;margin:10px auto 0;">
    ...
    <div class="mt-3">
        <button type="button" class="btn btn-outline-secondary" id="pdf2x_drop_hint">or drop PDF here</button>
    </div>
</div>
...
<script>
(function(){
    const status = document.getElementById('pdf2x_status');
    const input = document.getElementById('pdf2x_file');
    const label = document.querySelector('label[for="pdf2x_file"]');
    const drop = document.getElementById('pdf2x_drop_hint');
