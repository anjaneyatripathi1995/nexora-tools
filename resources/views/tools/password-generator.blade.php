...
@php
    $pageTitle = 'Password Generator — Strong & Secure';
    $pageDesc  = 'Generate strong, random passwords instantly. Customise length and character types. Free and private.';
@endphp
        ...
        <div class="tool-wrap">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:24px">
                <div class="form-group" style="grid-column:span 2;margin-bottom:0">
                    ...
                    <input type="range" id="lenSlider" min="6" max="64" value="16" style="width:100%;accent-color:var(--primary)">
                </div>
                @foreach ([['upper','Uppercase (A-Z)',true],['lower','Lowercase (a-z)',true],['nums','Numbers (0-9)',true],['syms','Symbols (!@#$)',true]] as [$id,$label,$chk])
            ...
            <div class="form-group">
                ...
                <select id="cnt" class="form-select">
            ...
            <div id="multiOut" style="margin-top:20px;display:none">
                <label class="form-label">All generated</label>
