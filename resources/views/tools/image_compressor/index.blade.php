...
<div class="container py-5">
    ...
    <div class="card shadow-sm"><div class="card-body"><p class="mb-0">Upload image, set quality/size, download compressed. Can reuse existing image-compressor partial.</p></div></div>
</div>
@endsection
