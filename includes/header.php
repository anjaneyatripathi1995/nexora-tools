 ...
 * Assets load from BASE_URL . 'assets/...' — works on XAMPP and Hostinger.
 */
...
<head>
    ...
    <!-- Main Stylesheet — loaded from /assets/css/style.css -->
...
<nav class="navbar" id="navbar">
    <div class="nav-inner">
        ...
        <div class="nav-actions">
            <button class="nav-icon-btn" id="searchToggle" title="Search (Ctrl+K)" aria-label="Search">
...
<div class="search-overlay" id="searchOverlay">
    <div class="search-overlay-inner">
        <div class="search-overlay-box">
            ...
            <input type="text" class="search-overlay-input" id="searchInput" placeholder="Search 40+ tools…" autocomplete="off">
