    ...
    <aside class="panel-sidebar" id="userSidebar">
        ...
        <nav class="panel-sidebar-nav">
            ...
            <div class="panel-nav-section">
                ...
                <a href="{{ route('projects.index') }}" class="panel-nav-link"><i class="fa-solid fa-folder"></i> Projects</a>
                <a href="{{ url('/') }}" class="panel-nav-link"><i class="fa-solid fa-home"></i> Home</a>
            </div>
        </nav>
        <div class="panel-footer">
            <a href="{{ route('profile') }}"><i class="fa-solid fa-user me-1"></i> Profile</a>
        </div>
    </aside>
