...
return [
    ...
    'site' => [
        'name' => 'Nexora Tools',
        'tagline' => 'Your Complete Tech Solution Hub',
        'desc' => 'Free online tools for PDF, images, developer utilities, SEO, finance & AI — all in one place.',
        'domain' => 'tripathinexora.com',
        'email' => 'contact@tripathinexora.com',
