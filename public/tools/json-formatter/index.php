...
$page_desc  = 'Format, validate and beautify JSON data online — free, instant, works in browser.';
require ROOT . '/includes/header.php';
?>
<div class="sub-banner"><div class="container"><div class="sub-banner-inner">
    <h1>{ } JSON Formatter</h1><p>Format, validate and beautify JSON instantly</p>
    <div class="breadcrumb"><a href="<?= BASE_URL ?>">Home</a> / <a href="<?= BASE_URL ?>tools">Tools</a> / JSON Formatter</div>
</div></div></div>
<section class="tool-page"><div class="container" style="max-width:1100px">
